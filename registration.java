...
class loginpage extends Frame implements ActionListener {
    ...
    public loginpage() {
        ...
        l1.setBounds(20, 80, 90, 20);
        l2.setBounds(20, 120, 90, 20);
        l3.setBounds(20, 160, 90, 20);
        ...
        t1.setBounds(120, 80, 230, 20);
        t2.setBounds(120, 120, 230, 20);
        t3.setBounds(120, 160, 230, 20);
        ...
        if (ae.getActionCommand().equals("submit")) {
            ...
            String password = "Anshika123";
             ...
             try{
                ...
                String insertQuery = "INSERT INTO register (UserId, Name, UserName, Password, MobileNumber, EmailId, DateOfJoining, Address, VehicleNumber) VALUES "
                        + "('" + UserId + "', '" + Name + "', '" + UserName + "', '" + Password + "', '" + MobileNumber + "', '" + EmailId + "', '" + DateOfJoining + "', '" + Address + "', '" + VehicleNumber + "')";
